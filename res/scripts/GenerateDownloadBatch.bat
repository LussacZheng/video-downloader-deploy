...
echo set "_versionAtCreation=%_Version_%">>%dl-bat-filename%
echo if NOT exist res\scripts\CurrentVersion goto next>>%dl-bat-filename%
echo set /p _versionCurrent=^<res\scripts\CurrentVersion>>%dl-bat-filename%
echo if NOT "%%_versionAtCreation%%"=="%%_versionCurrent%%" (>>%dl-bat-filename%
echo     echo. ^& echo %str_dl-bat-reset%>>%dl-bat-filename%
echo     pause ^& cls>>%dl-bat-filename%
echo )>>%dl-bat-filename%
echo :next>>%dl-bat-filename%
...
echo echo. ^& echo ----- ^& echo.>>%dl-bat-filename%

echo echo * %str_opt6%>>%dl-bat-filename%
echo echo     (%str_dl-guide6%)>>%dl-bat-filename%
echo echo.>>%dl-bat-filename%
echo echo [3/4] %str_dl-guide7%>>%dl-bat-filename%
echo echo.>>%dl-bat-filename%
...
echo     echo [3] %str_current-globalProxy-cmd%>>%dl-bat-filename%
...
echo if "%%state_ffmpeg%%"=="disable" ( echo [5] %str_ffmpeg-disabled% ^& echo. )>>%dl-bat-filename%
