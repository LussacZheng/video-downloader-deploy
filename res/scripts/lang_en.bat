...
set "str_opt6_opt4=Set options for 'wget'"
...
set "str_please-edit-wget-opt1=Please edit the "res\wget.opt" to change the default options."
set "str_please-edit-wget-opt2=Please re-perform this step here to confirm the modification."
set "str_please-edit-wget-opt3=To reset the default "wget.opt", please enter: 40"
